                        ...
                        <table id="datatablesSimple">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteCategory_<?php echo e($orders->id); ?>"> <i class="fa fa-decline"></i> Decline</button>
                                        ...
                                        <div class="modal right fade" id="deleteCategory_<?php echo e($orders->id); ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="staticBackdropLabel">decline Order</h4>
                                                ...
                                                <div class="modal-body" style="background: maroon;">
                                                    <form action="<?php echo e(route('orders_delete',['id'=>$orders->id])); ?>" method="post">
                                                        <?php echo csrf_field(); ?>

                                                        <p style="background:chartreuse; color: black;"> Are you sure you want to delete this <?php echo e($orders->product_title); ?> order from <?php echo e($orders->name); ?>?</p>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="fa fa-cancel"></i>Close</button>
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel1\Meshop\resources\views/admin/decline_orders.blade.php ENDPATH**/ ?>