                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                        <div class="btn-group">
                                            <button class="btn btn-sm btn-success"> <i class="fa fa-car"></i> Confirmed</button>
                                        ...
                                        <div class="modal right fade" id="deleteCategory_<?php echo e($orders->id); ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="staticBackdropLabel">Confirm Order</h4>
                                                ...
                                                <div class="modal-body" style="background: maroon;">
                                                    <form action="<?php echo e(route('confirm_orders',['id'=>$orders->id])); ?>" method="post">
                                                        <?php echo csrf_field(); ?>

                                                        <p style="background:chartreuse; color: black;"> Are you sure you want to confirm this <?php echo e($orders->product_title); ?> order from <?php echo e($orders->name); ?>?</p>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="fa fa-cancel"></i>Close</button>
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel1\Meshop\resources\views/admin/confirm.blade.php ENDPATH**/ ?>