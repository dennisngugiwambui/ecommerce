...
<html>
   ...
   <body>
      ...
      <div class="center">
        ...
        <div>
            <button class="btn btn-primary btn-block"> <a href="{{ route('cashPay') }}"> <i class="fa fa-money"></i> Pay Now</a></button>
        </div>
        <div>
            <button class="btn btn-secondary btn-block"> <a href="{{ route('stripe', $totalprice) }}"><i class="fa fa-cart-plus"></i> Pay using card</a></button>
        </div>
      </div>
      <!-- footer start -->
     @include('shop.footer')
