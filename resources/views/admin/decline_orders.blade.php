                        ...
                        <table id="datatablesSimple">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteCategory_{{ $orders->id }}"> <i class="fa fa-decline"></i> Decline</button>
                                        ...
                                        <div class="modal right fade" id="deleteCategory_{{ $orders->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-body" style="background: maroon;">
                                                    <form action="{{ route('orders_delete',['id'=>$orders->id]) }}" method="post">
                                                        @csrf

                                                        <p style="background:chartreuse; color: black;"> Are you sure you want to delete this {{ $orders->product_title }} order from {{ $orders->name }}?</p>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="fa fa-cancel"></i>Close</button>
