                        ...
                        <table id="datatablesSimple">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($orders->delivery_status=='cash on delivery')
                                        <div class="btn-group">
                                        ...
                                        <div class="modal right fade" id="deleteCategory_{{ $orders->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-body" style="background: maroon;">
                                                    <form action="{{ route('delivered_orders',['id'=>$orders->id]) }}" method="post">
                                                        @csrf

                                                        <p style="background:chartreuse; color: black;"> Are you sure you want to confirm this {{ $orders->product_title }} order from {{ $orders->name }} as delivered?</p>
                                                            <div class="modal-footer">
